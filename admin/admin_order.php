...
if(isset($_POST['update_order'])){
    ...
    $update_payment = $_POST['payment_method'];
    ...
    <div class="box_container">
        ...
        <div class="box">
            ...
            <form action="" method="POST">
                ...
                <input type="submit" name="update_order" value="update" class="option_btn">
                <a href="admin_order.php?delete=<?php echo $fetch_orders['id'];?>" class="delete_btn" onclick="return confirm('delete this order?');">delete</a>
            </form>
